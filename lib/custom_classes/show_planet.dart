...
class ShowPlanet extends StatelessWidget {
  ...
  final List imagesList = [kEarthImage, kMars1Image, kMercury3Image];
          ...
          return RotationTransition(
            ...
            child: SlideTransition(
              position: Tween<Offset>(
                begin:
                    ind == 0 ? const Offset(0.15, 0.1) : const Offset(0.7, 0.4),
                end: ind == 0
                    ? const Offset(0 - 0.6, -0.5)
                    : const Offset(-3.5, -2.2),
