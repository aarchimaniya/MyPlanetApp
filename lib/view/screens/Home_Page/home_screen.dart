...
import '../../../models/Plannet_DescrptionModel/planet_description_model.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  addDetails() {
    planetValues.add(PlanetDescriptionModel(
        name: 'EARTH', description: 'Our lovely planet'));
    planetValues
        .add(PlanetDescriptionModel(name: 'Mars', description: 'Neighbor'));
    planetValues
        .add(PlanetDescriptionModel(name: 'Mercury', description: 'Neighbor'));
  }
  ...
  void initState() {
    ...
    _earthOpacityAnimation =
        Tween<double>(begin: 1.0, end: 0.0).animate(_animationController);
    _welcomeOpacityAnimation =
        Tween<double>(begin: 1.0, end: 0.0).animate(_marsAnimationController);
    _marsOpacityAnimation =
        Tween<double>(begin: 0.8, end: 1.0).animate(_marsAnimationController);
    _earthReverseAnimation =
        Tween<double>(begin: 0.1, end: 0.5).animate(_animationController);

    _marsReverseAnimation =
        Tween<double>(begin: 0.04, end: 0.1).animate(_marsAnimationController);
    ...
    _marsHeightAnimationController.addListener(() {
      setState(() {
        _marsHeight =
            Tween<double>(begin: marsInitialHeight, end: marsFinalHeight)
        ...
        children: [
          ...
          showDetails
              ? AnimatedPositioned(
                  ...
                  right:
                      showDetailsAnimation ? customWidth * 0.06 : -customWidth,
                  duration: const Duration(milliseconds: 1500),
                  child: const Center(
          ...
          showDetails
              ? AnimatedPositioned(
                  ...
                  right:
                      showDetailsAnimation ? customWidth * 0.25 : -customWidth,
                  duration: const Duration(milliseconds: 1500),
                  child: const Center(
                    child: ShowText(),
                  ),
